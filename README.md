...
- Interactive comparison between K-Means and DBSCAN  
- Real-time parameter tuning  
- Visualization of cluster shapes and noise handling  
- Designed to build intuition for clustering behavior
